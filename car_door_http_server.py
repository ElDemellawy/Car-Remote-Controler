...
class CarDoorHTTPHandler(BaseHTTPRequestHandler):
            ...
            <body>
                <div class="container">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            <li>GET / - Get car door status</li>
                            <li>POST /lock - Lock car door</li>
                            <li>POST /unlock - Unlock car door</li>
                            <li>POST /api/car_door/status - CC3200 status updates</li>
                        </ul>
                    </div>
                    
                    <div class="status {'locked' if car_door_status == 'locked' else 'unlocked'}" id="carDoorStatus">
                    ...
                    <div style="text-align: center;">
                        <button class="button" onclick="sendCommand('unlock')">\uD83D\uDD13 UNLOCK CAR DOOR</button>
                        <button class="button" onclick="sendCommand('lock')">\uD83D\uDD12 LOCK CAR DOOR</button>
                    </div>
    ...
    def do_POST(self):
        """
        Handle POST requests for car door commands
        """
        ...
        elif self.path == "/api/car_door/status":
